...
import '../../../../controllers/worker_signup_controller.dart';
...
import 'worker_signup_address_data.dart';
import 'worker_signup_documents_data.dart';
...
class _WorkerSignupPageState extends State<WorkerSignupPage>
  ...
  dynamic get nextForm {
    controller.sendPressedNewPage();
    switch (_index) {
      case 0:
        if (controller.isFormValidPersonalSignup) {
          return () {
            if (_index < 2) {
              setState(() {
                _index += 1;
      ...
      case 1:
        if (controller.isFormValidDocumentSignup) {
          return () {
            if (_index < 2) {
              setState(() {
                _index += 1;
        ...
        break;
      default:
        if (controller.isFormValidAddressSignup) {
          return () {
            controller.register();
          };
        }
