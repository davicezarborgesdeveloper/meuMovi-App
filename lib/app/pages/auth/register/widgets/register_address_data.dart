...
class RegisterAddressData extends StatefulWidget {
  final RegisterController controller;
  const RegisterAddressData(this.controller, {Key? key}) : super(key: key);

  @override
  State<RegisterAddressData> createState() => _RegisterAddressDataState();
}

class _RegisterAddressDataState extends State<RegisterAddressData> {
                      ...
                      TextSpan(
                        ...
                        recognizer: TapGestureRecognizer()
                          ..onTap = () => Navigator.of(context)
                              .pushNamed('/auth/register/termsUse'),
                      ),
                      const TextSpan(
                        text:
