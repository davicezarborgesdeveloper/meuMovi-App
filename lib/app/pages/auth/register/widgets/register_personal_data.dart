...
class RegisterPersonalData extends StatefulWidget {
  final RegisterController controller;
  const RegisterPersonalData(this.controller, {Key? key}) : super(key: key);

  @override
  State<RegisterPersonalData> createState() => _RegisterPersonalDataState();
}

class _RegisterPersonalDataState extends State<RegisterPersonalData> {
