...
import '../../../../../controllers/syndicate/syndicate_worker_personal_data_controller.dart';
...
class _PersonalDataPageState extends State<PersonalDataPage>
  ...
  final SyndicateWorkerPersonalDataController controller =
      SyndicateWorkerPersonalDataController();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      statusDisposer = reaction((_) => controller.status, (status) {
        switch (status) {
          case SyndicateWorkerPersonalDataStateStatus.initial:
            break;
          case SyndicateWorkerPersonalDataStateStatus.loading:
            showLoader();
            break;
          case SyndicateWorkerPersonalDataStateStatus.loaded:
            hideLoader();
            break;
          case SyndicateWorkerPersonalDataStateStatus.saved:
            hideLoader();
            Navigator.pop(context, controller.workerModel);
            break;
          case SyndicateWorkerPersonalDataStateStatus.error:
            hideLoader();
