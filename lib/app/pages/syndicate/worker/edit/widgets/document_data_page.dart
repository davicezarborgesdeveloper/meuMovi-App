...
import '../../../../../controllers/syndicate/syndicate_worker_documents_controller.dart';
...
class _DocumentDataPageState extends State<DocumentDataPage>
  ...
  final SyndicateWorkerDocumentsController controller =
      SyndicateWorkerDocumentsController();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      statusDisposer = reaction((_) => controller.status, (status) {
        switch (status) {
          case SyndicateWorkerDocumentsStateStatus.initial:
            break;
          case SyndicateWorkerDocumentsStateStatus.loading:
            showLoader();
            break;
          case SyndicateWorkerDocumentsStateStatus.loaded:
            hideLoader();
            break;
          case SyndicateWorkerDocumentsStateStatus.saved:
            hideLoader();
            Navigator.pop(context, controller.workerModel);
            break;
          case SyndicateWorkerDocumentsStateStatus.error:
            hideLoader();
