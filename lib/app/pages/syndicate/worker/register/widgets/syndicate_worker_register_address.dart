...
class SyndicateWorkerRegisterAddress extends StatefulWidget {
  final SyndicateWorkerRegisterController controller;
  final List<TextEditingController> textControllers;
  const SyndicateWorkerRegisterAddress(
    this.controller,
  ...
  @override
  State<SyndicateWorkerRegisterAddress> createState() =>
      _SyndicateWorkerRegisterAddressState();
}

class WorkerSyndicateRegisterController {}

class _SyndicateWorkerRegisterAddressState
    extends State<SyndicateWorkerRegisterAddress> {
  @override
