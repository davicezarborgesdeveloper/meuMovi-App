...
class _BankAccountPageState extends State<BankAccountPage>
  ...
  final BankAccountController controller = BankAccountController();
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      statusDisposer = reaction((_) => controller.status, (status) {
        switch (status) {
          case BankAccountStateStatus.initial:
            break;
          case BankAccountStateStatus.loading:
            showLoader();
            break;
          case BankAccountStateStatus.loaded:
            hideLoader();
            break;
          case BankAccountStateStatus.saved:
            hideLoader();
            Navigator.pop(context);
            break;
          case BankAccountStateStatus.error:
            hideLoader();
