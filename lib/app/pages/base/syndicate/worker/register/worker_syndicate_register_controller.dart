...
part 'worker_syndicate_register_controller.g.dart';

enum WorkerSyndicateRegisterStateStatus {
  initial,
  loading,
  loaded,
  error,
...
class WorkerSyndicateRegisterController = WorkerSyndicateRegisterControllerBase
    with _$WorkerSyndicateRegisterController;

abstract class WorkerSyndicateRegisterControllerBase with Store {
  @readonly
  var _status = WorkerSyndicateRegisterStateStatus.initial;
  ...
  Future<void> searchZip(String zipFilter) async {
    _status = WorkerSyndicateRegisterStateStatus.loading;
    try {
      ...
      _status = WorkerSyndicateRegisterStateStatus.loaded;
    } catch (e, s) {
      log('Erro ao buscar cep', error: e, stackTrace: s);
      _status = WorkerSyndicateRegisterStateStatus.error;
    }
  }
  ...
  Future<void> register() async {
    try {
      ...
      _status = WorkerSyndicateRegisterStateStatus.saved;
    } catch (e, s) {
