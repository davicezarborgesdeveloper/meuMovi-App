...
mixin _$TaskServiceTakerRegisterController
  ...
  late final _$modeAtom = Atom(
      name: 'TaskServiceTakerRegisterControllerBase.mode', context: context);
  ...
  void setMode(int value) {
    final _$actionInfo =
        _$TaskServiceTakerRegisterControllerBaseActionController.startAction(
            name: 'TaskServiceTakerRegisterControllerBase.setMode');
    try {
  ...
  @override
  void setSyndicate(EmployeerModel? value) {
    final _$actionInfo =
        _$TaskServiceTakerRegisterControllerBaseActionController.startAction(
