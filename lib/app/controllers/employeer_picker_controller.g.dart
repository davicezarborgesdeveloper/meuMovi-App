...
mixin _$EmployeerPickerController on EmployeerPickerControllerBase, Store {
  ...
  late final _$_serviceTakerListAtom = Atom(
      name: 'EmployeerPickerControllerBase._serviceTakerList',
      context: context);
  ...
  late final _$findServiceTakerAsyncAction = AsyncAction(
      'EmployeerPickerControllerBase.findServiceTaker',
      context: context);

  @override
  Future<void> findServiceTaker(String id) {
    return _$findServiceTakerAsyncAction.run(() => super.findServiceTaker(id));
  }
