...
part 'syndicate_worker_personal_data_controller.g.dart';

enum SyndicateWorkerPersonalDataStateStatus {
  initial,
  loading,
  loaded,
  error,
...
class SyndicateWorkerPersonalDataController = SyndicateWorkerPersonalDataControllerBase
    with _$SyndicateWorkerPersonalDataController;

abstract class SyndicateWorkerPersonalDataControllerBase with Store {
  @readonly
  var _status = SyndicateWorkerPersonalDataStateStatus.initial;
  ...
  Future<void> save() async {
    try {
      _status = SyndicateWorkerPersonalDataStateStatus.loading;
      ...
      _status = SyndicateWorkerPersonalDataStateStatus.saved;
    } on Exception catch (e, s) {
      log('Erro ao atualizar usuário', error: e, stackTrace: s);
      _errorMessage = 'Erro ao atualizar usuário';
      _status = SyndicateWorkerPersonalDataStateStatus.error;
    }
  }
  ...
  Future<void> getUserData(WorkerModel worker) async {
    ...
    _status = SyndicateWorkerPersonalDataStateStatus.loaded;
  }
}
