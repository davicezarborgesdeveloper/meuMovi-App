...
mixin _$WorkerSignupController on WorkerSignupControllerBase, Store {
  ...
  bool get zipValid =>
      (_$zipValidComputed ??= Computed<bool>(() => super.zipValid,
          ...
          .value;
  Computed<bool>? _$isFormValidPersonalSignupComputed;

  @override
  bool get isFormValidPersonalSignup => (_$isFormValidPersonalSignupComputed ??=
          Computed<bool>(() => super.isFormValidPersonalSignup,
              name: 'WorkerSignupControllerBase.isFormValidPersonalSignup'))
      .value;
  Computed<bool>? _$isFormValidDocumentSignupComputed;

  @override
  bool get isFormValidDocumentSignup => (_$isFormValidDocumentSignupComputed ??=
          Computed<bool>(() => super.isFormValidDocumentSignup,
              name: 'WorkerSignupControllerBase.isFormValidDocumentSignup'))
      .value;
  Computed<bool>? _$isFormValidAddressSignupComputed;

  @override
  bool get isFormValidAddressSignup => (_$isFormValidAddressSignupComputed ??=
          Computed<bool>(() => super.isFormValidAddressSignup,
              name: 'WorkerSignupControllerBase.isFormValidAddressSignup'))
      .value;
...
zipValid: ${zipValid},
isFormValidPersonalSignup: ${isFormValidPersonalSignup},
isFormValidDocumentSignup: ${isFormValidDocumentSignup},
isFormValidAddressSignup: ${isFormValidAddressSignup}
    ''';
  }
}
