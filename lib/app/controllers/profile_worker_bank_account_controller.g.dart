...
mixin _$ProfileWorkerBankAccountController
  ...
  late final _$ProfileWorkerBankAccountControllerBaseActionController =
      ActionController(
          name: 'ProfileWorkerBankAccountControllerBase', context: context);

  @override
  void setBankData(BankDataModel value) {
    final _$actionInfo =
        _$ProfileWorkerBankAccountControllerBaseActionController.startAction(
            name: 'ProfileWorkerBankAccountControllerBase.setBankData');
    try {
      return super.setBankData(value);
    } finally {
      _$ProfileWorkerBankAccountControllerBaseActionController
